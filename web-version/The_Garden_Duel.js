...
(() => {
    ...
    async function loadPackage(metadata) {
        ...
        var PACKAGE_NAME = "The_Garden_Duel.data";
        var REMOTE_PACKAGE_BASE = "The_Garden_Duel.data";
        ...
        async function runWithFS(Module) {
            ...
            async function processPackageData(arrayBuffer) {
                ...
                Module["removeRunDependency"]("datafile_The_Garden_Duel.data")
            }

            Module["addRunDependency"]("datafile_The_Garden_Duel.data");
    ...
    loadPackage({
        files: [{filename: "/res/GoogleSans.ttf", start: 0, end: 2002260}, {filename: "/res/app.rc", start: 2002260, end: 2002299}, {
            filename: "/res/logo.ico",
            start: 2002299,
            end: 2015782
        }, {filename: "/res/logo.png", start: 2015782, end: 2038678}], remote_package_size: 2038678
    })
})();
...
function findWasmBinary() {
    return locateFile("The_Garden_Duel.wasm")
}
...
var FS = {
    root: null, mounts: [], devices: {}, streams: [], nextInode: 1, nameTable: null, currentPath: "/", initialized: false, ignorePermissions: true, filesystems: null, syncFSRequests: 0, ErrnoError: class extends Error {
        name = "ErrnoError";
...
var HEAP64;
var SYSCALLS = {
    currentUmask: 18, calculateAt(dirfd, path, allowEmpty) {
        if (PATH.isAbs(path)) {
            return path
        }
        var dir;
...
var registerFocusEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => {
    ...
    var eventHandler = {target: findEventTarget(target), eventTypeString, eventTypeId, userData, callbackfunc, handlerFunc: focusEventHandlerFunc, useCapture};
...
var registerFullscreenChangeEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => {
    ...
    var eventHandler = {target, eventTypeString, eventTypeId, userData, callbackfunc, handlerFunc: fullscreenChangeEventHandlerFunc, useCapture};
    return JSEvents.registerOrRemoveHandler(eventHandler)
};
...
var registerGamepadEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => {
    ...
    var eventHandler = {target: findEventTarget(target), allowsDeferredCalls: true, eventTypeString, eventTypeId, userData, callbackfunc, handlerFunc: gamepadEventHandlerFunc, useCapture};
    return JSEvents.registerOrRemoveHandler(eventHandler)
};
...
var registerPointerlockChangeEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => {
    ...
    var eventHandler = {target, eventTypeString, eventTypeId, userData, callbackfunc, handlerFunc: pointerlockChangeEventHandlerFunc, useCapture};
    return JSEvents.registerOrRemoveHandler(eventHandler)
};
...
var registerUiEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => {
    ...
    var eventHandler = {target, eventTypeString, eventTypeId, userData, callbackfunc, handlerFunc: uiEventHandlerFunc, useCapture};
    return JSEvents.registerOrRemoveHandler(eventHandler)
};
...
var registerVisibilityChangeEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => {
    ...
    var eventHandler = {target, eventTypeString, eventTypeId, userData, callbackfunc, handlerFunc: visibilityChangeEventHandlerFunc, useCapture};
    return JSEvents.registerOrRemoveHandler(eventHandler)
};
...
var Browser = {
    useWebGL: false, isFullscreen: false, pointerLock: false, moduleContextCreatedCallbacks: [], preloadedImages: {}, preloadedAudios: {}, getCanvas: () => Module["canvas"], init() {
        ...
        canvasContainer.requestFullscreen ??= (canvasContainer["webkitRequestFullscreen"] ? () => canvasContainer["webkitRequestFullscreen"](Element.ALLOW_KEYBOARD_INPUT) : null) ?? (canvasContainer["webkitRequestFullScreen"] ? () => canvasContainer["webkitRequestFullScreen"](Element.ALLOW_KEYBOARD_INPUT) : null);
...
var MainLoop = {
    func: null, scheduler: null, currentlyRunningMainloop: 0, arg: 0, timingMode: 0, timingValue: 0, currentFrameNumber: 0, queue: [], preMainLoop: [], postMainLoop: [], pause() {
...
var ASM_CONSTS = {
    34378: () => {
    ...
    }, 34424: () => Module.canvas.width, 34456: () => parseInt(Module.canvas.style.width), 34504: () => {
        ...
        if (document.fullscreenElement) return 1
    }, 34649: () => Module.canvas.width, 34681: () => screen.width, 34706: () => {
        document.exitFullscreen()
    }, 34733: $0 => {
    ...
    }, 34927: () => window.innerWidth, 34953: () => window.innerHeight, 34980: () => {
        if (document.fullscreenElement) return 1
    }, 35026: () => Module.canvas.width, 35058: () => parseInt(Module.canvas.style.width), 35106: () => {
        if (document.fullscreenElement) return 1
    }, 35152: () => Module.canvas.width, 35184: () => screen.width, 35209: () => window.innerWidth, 35235: () => window.innerHeight, 35262: () => {
        if (document.fullscreenElement) return 1
    }, 35308: () => Module.canvas.width, 35340: () => screen.width, 35365: () => {
        document.exitFullscreen()
    }, 35392: () => {
        if (document.fullscreenElement) return 1
    }, 35438: () => Module.canvas.width, 35470: () => parseInt(Module.canvas.style.width), 35518: () => {
        document.exitFullscreen()
    }, 35545: $0 => {
        Module.canvas.style.opacity = $0
    }, 35583: () => screen.width, 35608: () => screen.height, 35634: () => window.screenX, 35661: () => window.screenY, 35688: () => window.devicePixelRatio, 35724: $0 => {
        ...
        if (document.fullscreenElement) return 1
    }, 36265: () => window.innerWidth, 36291: () => window.innerHeight
};
